...
#line 1 "./asm/parser.y" /* yacc.c:337  */
...
#line 355 "./asm/parser.tab.c" /* yacc.c:337  */
# ifndef YY_NULLPTR
...
#line 288 "./asm/parser.y" /* yacc.c:352  */
...
#line 413 "./asm/parser.tab.c" /* yacc.c:352  */
...
union YYSTYPE
{
#line 313 "./asm/parser.y" /* yacc.c:352  */
...
#line 441 "./asm/parser.tab.c" /* yacc.c:352  */
};
...
{
       0,   328,   328,   329,   330,   334,   335,   339,   340,   344,
     348,   352,   356,   360,   364,   374,   381,   387,   393,   401,
     409,   422
};
#endif
...
{
  "$end", "error", "$undefined", "NEWLINE", "SEPERATOR", "SYMBOL",
  "STRING", "FLOAT", "INTEGER", "'='", "':'", "$accept", "input",
  "data_section", "assignments", "assignment", "instruction_units",
  "instruction_unit", "bare_instruction_unit", YY_NULLPTR
};
#endif
...
{
      -4,    -3,    16,    14,    -5,    -5,    -5,    17,    18,    19,
      20,    21,    -5,    22,    -5,    -5,    -5,    -5,    -5,    -5,
       3,    -5,    12,    -5,    15,    12,    -5,     6,    -5,    24,
      25,    26,    -5,    -5,    -5
};
...
{
       4,     0,     0,     2,    13,    16,    17,     0,     0,     0,
       0,     0,     1,     5,     3,    14,    21,    20,    19,    18,
       0,    15,     0,    12,     0,     6,     7,     0,     8,     0,
       0,     0,     9,    11,    10
};
...
{
       6,     1,     7,     8,     9,    10,     6,    11,     7,     8,
       9,    10,    29,    30,    31,    23,    12,    24,    13,     1,
      16,    17,    18,    19,    27,    22,    20,    32,    33,    34,
      28,    15,     0,     0,    21
};

static const yytype_int8 yycheck[] =
{
       3,     5,     5,     6,     7,     8,     3,    10,     5,     6,
       7,     8,     6,     7,     8,     3,     0,     5,     4,     5,
       3,     3,     3,     3,     9,     3,     5,     3,     3,     3,
      25,     3,    -1,    -1,    11
};
...
{
       0,     5,    12,    16,    17,    18,     3,     5,     6,     7,
       8,    10,     0,     4,    13,    17,     3,     3,     3,     3,
       5,    18,     3,     3,     5,    14,    15,     9,    15,     6,
       7,     8,     3,     3,     3
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 9:
#line 344 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct DataSectionEntry * entry = create_string_data_section_entry((yyvsp[-3].string), (yyvsp[-1].string));
  append_to_data_section(entry);
}
#line 1549 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 10:
#line 348 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct DataSectionEntry * entry = create_integer_data_section_entry((yyvsp[-3].string), (yyvsp[-1].integer));
  append_to_data_section(entry);
}
#line 1558 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 11:
#line 352 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct DataSectionEntry * entry = create_float_data_section_entry((yyvsp[-3].string), (yyvsp[-1]._double));
  append_to_data_section(entry);
}
#line 1567 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 13:
#line 360 "./asm/parser.y" /* yacc.c:1667  */
    {
  instruction_units = (yyvsp[0].instruction_units);
  inc_program_length();
}
#line 1576 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 14:
#line 364 "./asm/parser.y" /* yacc.c:1667  */
    {
  (yyvsp[-1].instruction_units)->next = (yyvsp[0].instruction_units);

  inc_program_length();

  (yyval.instruction_units) = (yyvsp[0].instruction_units);
}
#line 1588 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 15:
#line 374 "./asm/parser.y" /* yacc.c:1667  */
    {
  (yyvsp[0].instruction_units)->label = (yyvsp[-2].string);

  append_to_labels((yyvsp[-2].string), program_length);

  (yyval.instruction_units) = (yyvsp[0].instruction_units);
}
#line 1600 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 16:
#line 381 "./asm/parser.y" /* yacc.c:1667  */
    {
  (yyval.instruction_units) = (yyvsp[0].instruction_units);
}
#line 1608 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 17:
#line 387 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct InstructionUnit * instruction_unit = init_instruction_unit((yyvsp[-1].string));
  instruction_unit->arg_type = NULL_ARG;

  (yyval.instruction_units) = instruction_unit;
}
#line 1619 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 18:
#line 393 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct InstructionUnit * instruction_unit = init_instruction_unit((yyvsp[-2].string));

  instruction_unit->argument.integer = (yyvsp[-1].integer);
  instruction_unit->arg_type = INTEGER_ARG;

  (yyval.instruction_units) = instruction_unit;
}
#line 1632 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 19:
#line 401 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct InstructionUnit * instruction_unit = init_instruction_unit((yyvsp[-2].string));

  instruction_unit->argument._double = (yyvsp[-1]._double);
  instruction_unit->arg_type = FLOAT_ARG;

  (yyval.instruction_units) = instruction_unit;
}
#line 1645 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 20:
#line 409 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct InstructionUnit * instruction_unit = init_instruction_unit((yyvsp[-2].string));

  char * symbol = anonymous_symbol();
  struct DataSectionEntry * entry = create_string_data_section_entry(symbol, (yyvsp[-1].string));
...
#line 1663 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;

  case 21:
#line 422 "./asm/parser.y" /* yacc.c:1667  */
    {
  struct InstructionUnit * instruction_unit = init_instruction_unit((yyvsp[-2].string));

  instruction_unit->argument.symbol = (yyvsp[-1].string);
  instruction_unit->arg_type = SYMBOL_ARG;

  (yyval.instruction_units) = instruction_unit;
}
#line 1676 "./asm/parser.tab.c" /* yacc.c:1667  */
    break;


#line 1680 "./asm/parser.tab.c" /* yacc.c:1667  */
      default: break;
    }
...
#line 431 "./asm/parser.y" /* yacc.c:1918  */
